...
const STRINGS = {
    en: {
        ...
        contractInspector: {
            tag: 'BLUEPRINT::STUDIO',
            title: 'Contract Inspector',
            subtitle: 'Professional, transparent view of the GhostLinkSBT contract with live logic analysis.',
            ...
            liveLogicSummary: 'LIVE LOGIC SUMMARY',
            scrollToSee: 'Scroll through the code to see live function analysis',
            summary: 'Summary',
            parameters: 'Parameters',
            returns: 'Returns',
            lines: 'Lines',
            zkBadge: 'CORE_ZK_VERIFICATION_LOGIC',
    ...
    zh: {
        ...
        contractInspector: {
            tag: '图纸工作台',
            title: '合约审计台',
            subtitle: '专业、透明地展示 GhostLinkSBT 合约，配合实时逻辑分析。',
            ...
            loading: '加载中',
            loadFailed: '加载失败',
            liveLogicSummary: '实时逻辑摘要',
            scrollToSee: '滚动代码查看函数分析',
            summary: '摘要',
            parameters: '参数',
            returns: '返回值',
            lines: '行号',
