                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="md:col-span-2">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="font-bold text-xl font-mono text-white tracking-wider">
                        ...
                        <div className="flex items-center gap-4">
                            <a
                                ...
                                className="w-10 h-10 bg-slate-800 border border-slate-700 rounded-lg 
                    ...
                    {/* Resources */}
                    <div>
                        <h4 className="font-mono text-sm font-semibold text-white mb-4 tracking-wider">RESOURCES</h4>
                        <ul className="space-y-3">
                            <li>
                                <a href="#" className="text-slate-500 hover:text-cyan-400 text-sm transition-colors cursor-pointer flex items-center gap-1">
                                    Documentation <ExternalLink size={12} />
                                </a>
                            </li>
                            <li>
                                <a href="#" className="text-slate-500 hover:text-cyan-400 text-sm transition-colors cursor-pointer">
                                    API Reference
                                </a>
                            </li>
                            <li>
                    ...
                    {/* Company */}
                    <div>
                        <h4 className="font-mono text-sm font-semibold text-white mb-4 tracking-wider">COMPANY</h4>
                        <ul className="space-y-3">
                            <li>
                                <a href="#" className="text-slate-500 hover:text-cyan-400 text-sm transition-colors cursor-pointer">
                                    About
